    ...
    <div className="app-container">
      ...
      <section id="hero" className="hero">
        ...
        <div className="social-links animate-fade-in delay-4" style={{ marginTop: '1.5rem' }}>
          <a href="https://www.linkedin.com/in/nayan-vavdiya-b9bbab284/" target="_blank" rel="noreferrer" className="social-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
          </a>
          <a href="https://github.com/Nayanvavadiya" target="_blank" rel="noreferrer" className="social-icon">
